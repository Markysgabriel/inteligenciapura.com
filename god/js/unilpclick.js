...
var campaignIds = {
    'default': "657b7a0a23b1b90001426607",
}
var cookieDomain = "5mindivinemanifestation.com"
...
var initialSrc = "https://click.5mindivinemanifestation.com/" + campaignID + "?format=json" + "&referrer=" + referrer;
for (var i = 1; i <= 10; i++) {
...
function setHref(clickID, ref) {
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("https://click.5mindivinemanifestation.com/click") > -1) {
...
function xhrrOpenAndSend(clickID, ref) {
    ...
    if (getSessionRegisterViewOncePerSession() !== 1) {
        xhrr.open("GET", "https://click.5mindivinemanifestation.com/view?clickid=" + clickID + "&referrer=" + ref)
        xhrr.send();
    }
