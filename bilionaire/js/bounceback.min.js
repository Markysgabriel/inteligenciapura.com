...
!(function (a, b) {
    "function" == typeof define && define.amd
        ...
        ? global && global.testEnv
            ? b(global.testEnv, global.testEnv.document, exports)
            : b(a, document, exports)
        : (a.Bounceback = b(a, document, {}));
    ...
    return (
        ...
        (c.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(a.navigator.userAgent)),
        (c.disabled = !1),
        (c.activated = !1),
        (c.disable = function () {
        ...
        (c.activate = function (e) {
            if ("history" == e)
                "replaceState" in a.history
                    ? (a.history.replaceState({ isBouncing: !0 }, a.title),
                      a.history.pushState(null, a.title),
                      d(a, "popstate", function () {
                          a.history.state && a.history.state.isBouncing && c.onBounce();
                      }))
                    : "onhashchange" in a &&
                      (a.location.replace("#bht"),
                      (a.location.hash = ""),
                      d(a, "hashchange", function () {
        ...
        (c.init = function (c) {
            ...
            return (
                this.activated ||
                    (!c.aggressive && this.data.get(c.storeName)) ||
                    ((this.activated = !0), this.activate("history" === c.method || ("auto" === c.method && this.isMobile) ? "history" : "mouse"), this.data.set(c.storeName, "1")),
                this
            );
        }),
        c
